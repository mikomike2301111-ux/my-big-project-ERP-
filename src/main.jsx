...
function LeaveApplyModal({ user, leaveTypes, departments = [], balances = [], onClose, onSave }) {
  ...
  return (
    <ModalCard title="Apply for Leave" onClose={onClose}>
      <form className="settings-form-grid" onSubmit={e => { e.preventDefault(); onSave(form); }}>
        <fieldset className="settings-fieldset"><legend>Leave Details</legend><div>
          <label>Department
        ...
        <div className="leave-calc-preview">
          ...
          <div className="leave-calc-row"><span>Requested</span><strong style={{ color: exceedsBalance ? '#d92d20' : '#101828' }}>{days}d</strong></div>
          ...
          {exceedsBalance && <p className="leave-calc-warn">⚠ This request exceeds your available {form.type.toLowerCase()} balance.</p>}
        </div>
