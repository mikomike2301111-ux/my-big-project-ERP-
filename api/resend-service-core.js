...
// Sender addresses configured in Resend
const SENDERS = {
  noreply: 'FarmTrack ERP <noreply@farmtrack.co.ke>',
  support: 'FarmTrack Support <support@farmtrack.co.ke>',
  hr: 'FarmTrack HR <hr@farmtrack.co.ke>',
  finance: 'FarmTrack Finance <finance@farmtrack.co.ke>',
  procurement: 'FarmTrack Procurement <procurement@farmtrack.co.ke>',
  assets: 'FarmTrack Assets <assets@farmtrack.co.ke>'
};

const PLATFORM_NAME = 'FarmTrack ERP';
const PLATFORM_URL = 'https://staff.farmtrack.co.ke';
...
async function sendInvoiceCreated({ to, customerName, invoiceNo, amount, dueDate, invoiceId, companyName }) {
  ...
  return sendWithTracking({
    ...
    replyTo: 'support@farmtrack.co.ke'
  });
}
